...
static void write_register_multi(RadioComm *radio, uint8_t reg,
                                 const uint8_t *data, uint8_t len);
static void read_register_multi(RadioComm *radio, uint8_t reg, uint8_t *data,
                                uint8_t len);
...
static void ce_high(RadioComm *radio) { ESP_LOGD(TAG, "CE pin high"); }

static void ce_low(RadioComm *radio) { ESP_LOGD(TAG, "CE pin low"); }

static void csn_high(RadioComm *radio) { ESP_LOGD(TAG, "CSN pin high"); }

static void csn_low(RadioComm *radio) { ESP_LOGD(TAG, "CSN pin low"); }
...
static void power_up(RadioComm *radio) { ESP_LOGD(TAG, "Power up radio"); }

static void set_rx_mode(RadioComm *radio) { ESP_LOGD(TAG, "Set RX mode"); }
